...
package.domain = com.aynurnuraddingizi

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,json,sqlite3,ttf,txt
...
source.exclude_dirs = build,dist,__pycache__,cefr_data,dict_data,phrase_data,.git,.buildozer,vocabmaster,bin

# (list) List of exclusions using pattern matching
# Do not prefix with './'
source.exclude_patterns = *.exe,TextAnalyzer.spec,*.pyc,*_anki.txt
